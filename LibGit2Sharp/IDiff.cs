...
namespace LibGit2Sharp
{
    public interface IDiff
    {
        ...
        TreeChanges Compare(Tree oldTree, Tree newTree, IEnumerable<string> paths = null);
        ...
        TreeChanges Compare(Tree oldTree, DiffTarget diffTarget, IEnumerable<string> paths = null);
    }
}