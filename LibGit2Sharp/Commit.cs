...
namespace LibGit2Sharp
{
    ...
    public class Commit : GitObject
    {
        ...
        /// <summary>
        /// Gets the <see cref="TreeEntry"/> pointed at by the <paramref name="relativePosixPath"/> in the <see cref="Tree"/>.
        /// </summary>
        /// <param name="relativePosixPath">The posix-style relative path to the <see cref="TreeEntry"/> from the <see cref="Commit"/> working directory.</param>
        /// <returns><c>null</c> if nothing has been found, the <see cref="TreeEntry"/> otherwise.</returns>
        public virtual TreeEntry this[string relativePosixPath]
        {
            get { return Tree[relativePosixPath]; }
        }
