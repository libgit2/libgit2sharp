...
namespace LibGit2Sharp
{
    ...
    public static class RepositoryExtensions
    {
        ...
        /// <returns></returns>
        public static T Lookup<T>(this IRepository repository, string shaOrRef) where T : IGitObject
        {
        ...
        /// <returns></returns>
        public static T Lookup<T>(this IRepository repository, ObjectId id) where T : IGitObject
        {
        ...
        public static IBranch CreateBranch(this IRepository repository, string branchName)
        {
        ...
        public static IBranch CreateBranch(this IRepository repository, string branchName, ICommit target)
        {
        ...
        public static IBranch CreateBranch(this IRepository repository, string branchName, string target)
        {
        ...
        public static ICommit Commit(this IRepository repository, string message, bool amendPreviousCommit = false)
        {
        ...
        /// <param name = "amendPreviousCommit">True to amend the current <see cref = "LibGit2Sharp.Commit"/> pointed at by <see cref = "Repository.Head"/>, false otherwise.</param>
        /// <returns>The generated <see cref = "LibGit2Sharp.Commit" />.</returns>
        public static ICommit Commit(this IRepository repository, string message, Signature author, bool amendPreviousCommit = false)
        {
        ...
        /// <param name = "amendPreviousCommit">True to amend the current <see cref = "LibGit2Sharp.Commit"/> pointed at by <see cref = "Repository.Head"/>, false otherwise.</param>
        /// <returns>The generated <see cref = "LibGit2Sharp.Commit" />.</returns>
        public static ICommit Commit(this IRepository repository, string message, Signature author, Signature committer, bool amendPreviousCommit = false)
        {
