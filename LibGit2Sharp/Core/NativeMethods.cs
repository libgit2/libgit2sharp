...
namespace LibGit2Sharp.Core
{
    internal static class NativeMethods
    {
        ...
        /*
        // An example of callback definition (taken from http://www.codeproject.com/Tips/318140/How-to-make-a-callback-to-Csharp-from-C-Cplusplus)
        // define a progress callback delegate
        source_callback fileCallback =
            (content, max_length, data) =>
            {
                blah-blah-blah++;
                return 0;
            };
        ...
        public static extern int git_blob_create_fromchunks(
            ...
            [MarshalAs(UnmanagedType.FunctionPtr)] source_callback fileCallback,
            IntPtr data);
        ...
        public static extern int git_branch_foreach(
            RepositorySafeHandle repo,
            GitBranchType branch_type,
            [MarshalAs(UnmanagedType.FunctionPtr)] branch_foreach_callback branch_cb,
            IntPtr payload);
        ...
        public static extern int git_diff_foreach(
            ...
            IntPtr callbackData,
            [MarshalAs(UnmanagedType.FunctionPtr)] git_diff_file_fn fileCallback,
            [MarshalAs(UnmanagedType.FunctionPtr)] git_diff_hunk_fn hunkCallback,
            [MarshalAs(UnmanagedType.FunctionPtr)] git_diff_data_fn lineCallback);
        ...
        public static extern int git_note_foreach(
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(Utf8Marshaler))] string notes_ref,
            [MarshalAs(UnmanagedType.FunctionPtr)] notes_foreach_callback callback,
            IntPtr payload);
        ...
        public static extern int git_reference_foreach_glob(
            ...
            [MarshalAs(UnmanagedType.FunctionPtr)] ref_glob_callback callback,
            IntPtr payload);
        ...
        [DllImport(libgit2, CallingConvention = CallingConvention.Cdecl)]
        public static extern int git_status_foreach(
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.FunctionPtr)] status_callback callback,
            IntPtr payload);
