...
namespace LibGit2Sharp
{
    ...
    public class ObjectDatabase
    {
        ...
        public Commit CreateCommit(string message, Signature author, Signature committer, Tree tree, IEnumerable<ICommit> parents)
        {
            return CreateCommit(message, author, committer, tree, parents, null);
        }

        internal Commit CreateCommit(string message, Signature author, Signature committer, Tree tree, IEnumerable<ICommit> parents, string referenceName)
        {
