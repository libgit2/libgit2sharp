...
namespace LibGit2Sharp.Tests
{
    public class TagFixture : BaseFixture
    {
        ...
        private static readonly Signature signatureTim = new Signature("Tim Clem", "timothy.clem@gmail.com",
                                                                       DateTimeOffset.UtcNow);

        private static readonly Signature signatureNtk = new Signature("nulltoken", "emeric.fermas@gmail.com",
                                                                       Epoch.ToDateTimeOffset(1300557894, 60));
        ...
        public void CanCreateATagPointingToABlob()
        {
            ...
            {
                ICommit headCommit = repo.Head.Tip;
                IBlob blob = headCommit.Tree.Blobs.First();
        ...
        public void BlindlyCreatingAnAnnotatedTagOverAnExistingOneThrows()
        {
            using (var repo = new Repository(BareTestRepoPath))
            {
                Assert.Throws<LibGit2SharpException>(
                    () => repo.Tags.Create("e90810b", "refs/heads/br2", signatureNtk, "a nice message"));
            }
        }
        ...
        public void CreateTagWithEmptyNameThrows()
        {
            using (var repo = new Repository(BareTestRepoPath))
            {
                Assert.Throws<ArgumentException>(
                    () => repo.Tags.Create(string.Empty, "refs/heads/master", signatureTim, "message"));
            }
        }
        ...
        public void CreateTagWithEmptyTargetThrows()
        {
            ...
            {
                Assert.Throws<ArgumentException>(
                    () => repo.Tags.Create("test_tag", string.Empty, signatureTim, "message"));
            }
        }
        ...
        public void CreateTagWithNotExistingTargetThrows()
        {
            ...
            {
                Assert.Throws<LibGit2SharpException>(
                    () => repo.Tags.Create("test_tag", Constants.UnknownSha, signatureTim, "message"));
            }
        }
        ...
        public void CreateTagWithNullMessageThrows()
        {
            using (var repo = new Repository(BareTestRepoPath))
            {
                Assert.Throws<ArgumentNullException>(
                    () => repo.Tags.Create("test_tag", "refs/heads/master", signatureTim, null));
            }
        }
        ...
        public void CreateTagWithNullNameThrows()
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(
                    () => repo.Tags.Create(null, "refs/heads/master", signatureTim, "message"));
            }
        }
        ...
        public void CreateTagWithNullSignatureThrows()
        {
            ...
            {
                Assert.Throws<ArgumentNullException>(
                    () => repo.Tags.Create("test_tag", "refs/heads/master", null, "message"));
            }
        }
