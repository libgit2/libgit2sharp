...
REM  - build.Developer.cmd
REM
REM  Building, running tests and embedding the libgit2sharp commit sha
REM  - build.Developer.cmd "6a6eb81272876fd63555165beef44de2aaa78a14"
REM
REM  Building and identifying potential leaks while running tests
REM  - build.Developer.cmd "unknown" "LEAKS_IDENTIFYING"
...
"%FrameworkDir%\%FrameworkVersion%\msbuild.exe" "%BASEDIR%CI\Developer.msbuild" /property:CommitSha=%CommitSha% /property:ExtraDefine="%ExtraDefine%" /property:Configuration=Debug
