...
GIT_EXTERN(int) wrapped_git_reference_lookup(git_reference** ref_out, git_rtype *type_out,  git_repository* repo, const char* reference_name, int should_recursively_peel);
GIT_END_DECL
